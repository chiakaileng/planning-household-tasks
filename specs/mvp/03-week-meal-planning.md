...
- Dish content: **recipe** (pool), **leftovers of a meal from the last 7 days**, **leftover free text**, **free-form** (takeaway, freezer, …)
- From a **recipe page**: assign that recipe as content on a meal (day + slot, eaters, cook)
...
- Edit or remove a dish; change eaters/cook/content
...
- From a recipe page I can assign that recipe onto a day + meal, with eaters and cook; it appears on the week
...
- Leftovers-of-a-meal: only meals from the **last 7 days** (from today). Older ones do not appear. If that source meal is later removed, keep the leftover dish and its title; it becomes ordinary leftover text
...
- Week boundaries: leftover “last 7 days” can include meals from the previous week
